...
alias .testnetsha=".stop;.rm;.build;.run;.start;\
          sudo docker exec -it $NAME su parallelcoin -c \"/work/parallelcoin/src/parallelcoind -rpcuser=rpcuser --privileged \
...
alias .testnetscrypt=".stop;.rm;.build;.run;.start;\
          sudo docker exec -it $NAME su parallelcoin -c \"/work/parallelcoin/src/parallelcoind -rpcuser=rpcuser --privileged \
          -rpcpassword=pa55word -conf=/work/testnet.conf -datadir=/work \
